                                ...
                                if($data['unique_id'] != $_COOKIE['_aut_ui_'])
                                {
                                    if($data['profilepic'] == "NULL")
                                    {
                                        ...
                                        if(isset($_COOKIE['frd_request'.$data['unique_id']]) == $data['unique_id'])
                                        {
                                            ...
                                            echo "<tr>
                                                <td><center><img src=".$data["profilepic"]." class='img'></center></td>
                                                <td><center>".$data['username']."</center></td>
                                                <td><center><i class='fa fa-telegram requestbtn text-success' aria-hidden='true' rid=".$data['unique_id']." sid=".$_COOKIE['_aut_ui_']." id=btnid_".$data['id']." type='request_unsend'></i></center></td>
                                                </tr>";
                                        }
                                        elseif(isset($_COOKIE['acceptfrd_'.$data['unique_id']]) == $data['unique_id'])
                                        {
                                            echo "<tr>
                                                <td><center><img src=".$data["profilepic"]." class='img'></center></td>
                                                <td><center>".$data['username']."</center></td>
                                                <td><center><i class='fa fa-group requestbtn text-info' aria-hidden='true' rid=".$data['unique_id']." sid=".$_COOKIE['_aut_ui_']." id=btnid_".$data['id']." type='request_unfriend'></i></center></td>
                                                </tr>"; 
                                        }
                                        else{
